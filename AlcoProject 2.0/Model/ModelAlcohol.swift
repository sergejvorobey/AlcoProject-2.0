...
private let fanta = NonAlcoholDrink(name: "Fanta",
                                   details: "Безалкогольный сильногазированный прохладительный напиток с цитрусовым вкусом; выпускается корпорацией Coca-Cola. Основной вариант вкуса - апельсиновый; в разных странах также выпускаются различные вкусовые варианты, например, в России по состоянию на 2020 год выпускаются варианты с апельсиновым, грушёвым вкусом и вкусом ШОКата.",
                                   alcoholLevel: "",
                                   image: "Fanta")

private let sprite = NonAlcoholDrink(name: "Sprite",
                                   details: "Газированный безалкогольный напиток, со вкусом лайма и лимона, принадлежащий американской компании The Coca-Cola Company. Изначально Спрайт позиционировался как содовая со вкусом лимона.",
                                   alcoholLevel: "",
                                   image: "Sprite")
